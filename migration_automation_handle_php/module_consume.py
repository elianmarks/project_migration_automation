...
from migration_automation_handle_php.module_handle_php import ModuleHandlePHP
...
class ModuleConsume:
    ...
    def __init__(self, queue, development=None):
        ...
        self.module_handle_php = ModuleHandlePHP(self.module_log.log, self.module_configuration)
    ...
    def config_init(self):
        ...
        try:
            ...
            if not self.module_configuration.initialize():
                ...
                # instance the ModuleLog class to Handle PHP path log (9)
                self.module_log = ModuleLog(self.module_configuration, 9)
        ...
        **values** - dict with message value
        ...
        try:
            ...
            if properties.headers.get("x-key") is not None and \
                ...
                if self.module_handle_php.initialize(self._values):
                    # run process in check
                    self.module_handle_php.process()
